...
## Program Management
The `program` command not only allows you to assign a workout to a given day, but it allows you to track or log your completed exercises.
...
## Tracking Workouts
You are also able to track the amount of weight, sets and repetitions you have completed for an exercise on a given day, through the tracking functionality. 

In order to track your exercises, must first have a workout plan assigned to the day that you are tracking. However, you may log an exercise that was not originally in the workout plan to allow for flexibility of programs. 
...
Expected outcome:
```
[BYTE-CEPS]> Successfully tracked 125kg benchpress with 3 sets and 5 reps on 2024-03-28
```
...
Expected outcome:
```
[BYTE-CEPS]> Successfully tracked 125kg benchpress with 3 sets and 5 reps on 2024-03-25
```
