...
public class GroceryListTest {
    ...
    public void addGrocery_throwIllegalArgument_exceptionThrown() {
        try {
            GroceryList gl = new GroceryList();
            gl.addGrocery(new Grocery(null, 0, null, "Meat", 0)); // Use null to trigger the exception
    ...
    public void removeGrocery_groceryDelete_exceptionThrown() {
        try {
            GroceryList gl = new GroceryList();
            gl.addGrocery(new Grocery("fooood", 0, null, "Meat", 0));
    ...
    public void editAmountUseTrue_amountReaches0_success() {
        GroceryList gl = new GroceryList();
        try {
            gl.addGrocery(new Grocery("Meat", 5, LocalDate.now(), "Meat", 0));
